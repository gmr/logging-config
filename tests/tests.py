...
class LoggingConfigTests(unittest.TestCase):
    ...
    def test_setup_formatters(self):
        ...
        self.assertIsInstance(formatters['syslog'], logging.Formatter)
    ...
    def test_setup_filters(self):
        ...
        self.assertIsInstance(filters['test'], logging.Filter)
    ...
    def test_new_handler(self):
        ...
        self.assertIsInstance(response, logging.StreamHandler)
    ...
    def test_setup_missing_class(self):
        ...
        cfg_obj.setup()
        self.assertIsInstance(cfg_obj._handlers[0], logging.StreamHandler)
    ...
    def test_setup_missing_level(self):
        ...
        cfg_obj.setup()
        self.assertIsInstance(cfg_obj._handlers[0],
    ...
    def test_setup_internal_handler(self):
        ...
        self.assertIsInstance(self._logging._logger.handlers[0],
